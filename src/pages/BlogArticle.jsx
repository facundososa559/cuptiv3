    ...
    <div>
      ...
      <main className="
        ...
        <div className="flex flex-col gap-(--spacing-xs) border-b-1 border-(--neutral-light) pb-(--spacing-sm)">
          <span className="paragraph">{article.author} | {article.date}</span>
        ...
        <article className="flex flex-col">
          <ReactMarkdown
            components={{
              h2: ({ node, ...props }) => <h2 className="heading-4 text mt-8 mb-4" {...props} />,
              h3: ({ node, ...props }) => <h3 className="heading-5 text mt-6 mb-3" {...props} />,
              p: ({ node, ...props }) => <p className="paragraph text-(--neutral) mb-4" {...props} />,
              ...
              li: ({ node, ...props }) => <li className="paragraph text-(--neutral)" {...props} />,
              blockquote: ({ node, ...props }) => <blockquote className="border-l-4 border-(--primary) pl-4 italic text-(--muted) my-6" {...props} />,
